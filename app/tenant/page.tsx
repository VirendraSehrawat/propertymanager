...
export default function TenantDashboard() {
    ...
    const handlePayInvoice = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Upload screenshot
            const ssRef = ref(storage, `payments/${user!.uid}/${Date.now()}_${payScreenshot.name}`);
            await uploadBytes(ssRef, payScreenshot);
            const screenshotUrl = await getDownloadURL(ssRef);
