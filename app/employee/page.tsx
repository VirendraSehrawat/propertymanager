...
import { CollectionsTab, OccupancyTab, LedgerTab, TicketsTab, MeterTab, ExpensesTab, InventoryTab, DailyLedgerTab, MonthlyOverviewTab, HomeTab, ChecklistTab } from "@/components/employee";
...
export default function EmployeeDashboard() {
    ...
    // Checklists (owned here for snapshot listener; ChecklistTab manages form state)
            ...
            <main className="p-4 max-w-2xl mx-auto space-y-6 mt-2">
                ...
                {activeTab === "home" && (
                    <HomeTab
                        ...
                        onOpenTodayCollections={() => setIsTodayCollectionsOpen(true)}
                ...
                {/* CHECKLIST TAB */}
                {activeTab === "checklist" && (
                    <ChecklistTab allUnits={allUnits} occupiedUnits={occupiedUnits} buildings={buildings} allChecklists={allChecklists} userEmail={user?.email || ""} />
                )}
