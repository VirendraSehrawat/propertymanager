...
import { collection, onSnapshot, doc, updateDoc, arrayUnion, query, where, writeBatch, getDocs, addDoc, deleteField, deleteDoc } from "firebase/firestore";
...
import { CollectionsTab, OccupancyTab, LedgerTab, TicketsTab, MeterTab, InventoryTab, DailyLedgerTab, MonthlyOverviewTab, MonthCollectionsCard } from "@/components/employee";
